...
VOID Fini(INT32 code, VOID* v)
{
	...
	cout << "(3gen) In Fini_Prarent, count: " << test_count << ", fileName: " << fileName << "pid: "  << getpid() << endl;
...
BOOL FollowChild(CHILD_PROCESS childProcess, VOID * userData)
{
    ...
    CHILD_PROCESS_GetCommandLine(childProcess, &appArgc, &appArgv);
		...
		cout << "(3gen) In Child entry: Child PID: " << pid << ", parent pid: "  << getpid() << endl;
...
int main(int argc, char* argv[])
{
  ...
  cout << "In 3gen: Current process id = " << getpid() << endl << flush;
