...
VOID Fini(INT32 code, VOID* v)
{
	...
	cout << "In Fini_cmdl_3gen, count: " << test_count << ", fileName: " << fileName
...
BOOL FollowChild(CHILD_PROCESS childProcess, VOID * userData)
{
    ...
    CHILD_PROCESS_GetCommandLine(childProcess, &appArgc, &appArgv);
		...
		cout << "In Child entry(cmdl_3gen): Child PID: " << pid << ", getpid(): "  << getpid() << ", GetCurrentProcessId: "<< WIND::GetCurrentProcessId()<< endl;
