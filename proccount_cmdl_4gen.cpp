...
VOID Fini(INT32 code, VOID* v)
{
	...
	cout << "(4gen) In Fini_Prarent, count: " << test_count << ", fileName: " << fileName << "pid: "  << getpid() << endl;
...
BOOL FollowChild(CHILD_PROCESS childProcess, VOID * userData)
{
    ...
    CHILD_PROCESS_GetCommandLine(childProcess, &appArgc, &appArgv);
		...
		cout << "(4gen) In Child entry: Child PID: " << pid << ", parent pid: "  << getpid() << endl;
...
int main(int argc, char* argv[])
{
  ...
  cout << "In 4gen: Current process id = " << getpid() << endl << flush;
